...
namespace Microsoft.EntityFrameworkCore
{
    ...
    internal static class ListExtensions
    {
        ...
        public static IList<T> InsertBefore<T, TExisting>(this IList<T> list, T item)
            where TExisting : T
            where T : class
        {
        ...
        /// <returns>The modified <paramref name="list"/>, such that calls can be chained.</returns>
        public static IList<TBase> Replace<TBase, TReplacement>(
            this IList<TBase> list,
            TReplacement replacement)
            where TReplacement : class, TBase
        {
            Check.NotNull(list, nameof(list));
        ...
        /// <returns>The modified <paramref name="list"/>, such that calls can be chained.</returns>
        public static IList<T> Without<T>(this IList<T> list, Func<T, bool> predicate)
        {
            Check.NotNull(list, nameof(list))
                .Where(predicate)
                .ToList()
